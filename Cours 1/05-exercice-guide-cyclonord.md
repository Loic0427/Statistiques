...
|---|---|---|
| `ID_commande` |  <span style="color: red;">Identifiant |  <span style="color: red;">Non |
| `Date_commande` |  <span style="color: red;">Date | <span style="color: red;"> Non  |
| `Magasin` |  <span style="color: red;">Quantitatif nominale |  <span style="color: red;">Non |
| `Departement` | <span style="color: red;"> Quantitatif nominale |  <span style="color: red;">Non |
| `Categorie` |  <span style="color: red;">Quantitatif nominale | <span style="color: red;"> Non |
| `Produit` |  <span style="color: red;">Qualitative nominale|  <span style="color: red;">Non|
| `Canal` |  <span style="color: red;">Qualitative nominale|  <span style="color: red;">Non|
| `Quantite` | <span style="color: red;">Quantitative continue | <span style="color: red;">Oui |
| `Prix_unitaire_TTC` |  <span style="color: red;">Quantitative discrète|  <span style="color: red;">Oui|
| `Remise` |  <span style="color: red;">Quantitative continue|  <span style="color: red;">Oui|
| `Montant_TTC` | <span style="color: red;">Quantitative discrète | <span style="color: red;">Oui |
| `Statut` | <span style="color: red;">Qualitative nominale | <span style="color: red;">Non |
| `Note_client` |  <span style="color: red;">Qualitative ordinale|  <span style="color: red;">Oui|
...
```
 ...
 <span style="color: red;">Montant_TTC	=MOYENNE(T_ventes[Montant_TTC])	=MEDIANE(T_ventes[Montant_TTC])	=MODE.SNGL(T_ventes[Montant_TTC])
Prix_unitaire_TTC	=MOYENNE(T_ventes[Prix_unitaire_TTC])	=MEDIANE(T_ventes[Prix_unitaire_TTC])	=MODE.SNGL(T_ventes[Prix_unitaire_TTC])
Note_client	=MOYENNE(T_ventes[Note_client])	=MEDIANE(T_ventes[Note_client])	=MODE.SNGL(T_ventes[Note_client])
...
de chacune de ces trois distributions ? *(3 lignes)*
 ...
 <span style="color: red;">Cela nous prouve que plus il y a de valeur différentes dans la colonne, plus l'écrart sera important </span>
...
<span style="color: red;">La phrase est inccorecte. La phrase correcte est la suivante : "La note moyenne des commandes qui ont été notés par les clients est de 4,1/5"
...
<span style="color: red;"> =SOMME(T_ventes[Montant_TTC])
...
<span style="color: red;">=SOMME.SI.ENS(T_ventes[Montant_TTC]; T_ventes[Categorie] ; "VAE") 
<span style="color: red;">=SOMME.SI(T_ventes[Categorie];"VAE";T_ventes[Montant_TTC])/SOMME(T_ventes[Montant_TTC])
